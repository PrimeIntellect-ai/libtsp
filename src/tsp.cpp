...
TSP_EXPORT TSPStatus tspSolveAsymmetric(const TspInputGraphDescriptor *graph,
    ...
    return tspImproveSolutionAsymmetric(graph, nullptr, solver_options, output_descriptor);
}

TSPStatus tspImproveSolutionAsymmetric(const TspInputGraphDescriptor *graph,
    ...
    if (initial_solution != nullptr) {
        best_cost = initial_solution->solution_cost;
